  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[color:var(--color-bg)]/95 backdrop-blur-md border-b border-[color:var(--color-surface-strong)] shadow-sm">
      <nav className="max-w-7xl mx-auto pl-3 pr-4 sm:pl-4 sm:pr-5 lg:pl-4 lg:pr-6 min-h-18 py-3 flex items-center gap-2 sm:gap-3 lg:gap-4 min-w-0">
        ...
        <ul className="hidden lg:flex flex-1 min-w-0 justify-center items-center gap-0.5 overflow-visible px-1 sm:px-2">
          {links.map((link) =>
            link.galleryNav ? (
              <li key={`${link.href}-${link.label}-gallery`} className="relative shrink-0">
                <div ref={galleryNavRef} className="relative">
                  <button
                    ...
                    className="inline-flex shrink-0 cursor-pointer items-center gap-1 whitespace-nowrap rounded-lg border border-transparent px-2 py-1.5 text-sm font-semibold tracking-tight text-[color:var(--color-primary)] transition-colors hover:bg-[color:var(--color-surface)] hover:text-[#4c83cf] focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--color-bg)]"
              ...
              <li key={`${link.href}-${link.label}`}>
                <a
                  href={link.href}
                  className="inline-flex shrink-0 whitespace-nowrap items-center text-sm font-semibold tracking-tight text-[color:var(--color-primary)] px-2 py-1.5 rounded-lg hover:bg-[color:var(--color-surface)] hover:text-[#4c83cf] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--color-bg)]"
                >
                  {link.label}
                </a>
              </li>
              ...
              link.galleryNav ? (
                <li key={`${link.href}-${link.label}-gallery-mobile`}>
                  <details className="group rounded-xl border border-transparent open:border-[color:var(--color-surface-strong)] open:bg-[color:var(--color-surface)]/40">
                    <summary className="cursor-pointer list-none px-3 py-2 text-sm font-semibold tracking-tight text-[color:var(--color-primary)] marker:hidden [&::-webkit-details-marker]:hidden">
                ...
                <li key={`${link.href}-${link.label}`}>
                  <a
                    href={link.href}
                    className="block text-sm font-semibold tracking-tight text-[color:var(--color-primary)] px-3 py-2 rounded-lg hover:bg-[color:var(--color-surface)] hover:text-[#4c83cf] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-accent)] focus-visible:ring-offset-2"
